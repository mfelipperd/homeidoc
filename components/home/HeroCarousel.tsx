                  ...
                  <div className="container-custom w-full">
                    ...
                    <div className="w-full max-w-5xl mx-auto p-8 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
                      <div className="flex-1 text-center md:text-left">
                        <h2 
                          className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 text-white drop-shadow-xl leading-tight"
                          style={{ color: '#FFFFFF' }}
                        >
                          {slide.title}
                        </h2>
                        <p 
                          className="text-xl md:text-2xl text-white font-medium drop-shadow-lg"
                          style={{ color: '#FFFFFF' }}
                        >
                          {slide.subtitle}
                        </p>
